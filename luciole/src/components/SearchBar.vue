<template>
  ...
  <input type="text" placeholder="Rechercher" class="w-full px-8 py-2 rounded-3xl border border-gray-400 focus:outline-none">
  <svg class="absolute left-1.5" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
